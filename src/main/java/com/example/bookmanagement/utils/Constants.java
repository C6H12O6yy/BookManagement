...
public class Constants {
     ...
     */
    public static final String BASE_PACKAGE = "com.example.bookmanagement.controllers";
     ...
     */
    public static final String API_TITLE = "Book Management API";

    /**
     * The description for the API documentation.
     */
    public static final String API_DESCRIPTION = "API documentation for the Book Management application.";
